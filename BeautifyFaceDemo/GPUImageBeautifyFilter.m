...
- (id)init;
{
    ...
    UIView *temp = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 375, 667)];
    temp.backgroundColor=[UIColor redColor];
    GPUImageUIElement *uiElementInput = [[GPUImageUIElement alloc] initWithView:temp];
    
    [uiElementInput addTarget:combinationFilter];
